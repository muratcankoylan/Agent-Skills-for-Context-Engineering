...
```
python3 researcher/scripts/validate_all.py                    # canonical local gate runner
...
14. **Run `python3 researcher/scripts/validate_all.py`** before committing skill changes; use the individual gates below it only when debugging a specific failure
