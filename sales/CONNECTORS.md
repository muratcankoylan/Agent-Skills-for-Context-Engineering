...
| CRM                   | `~~CRM`                       | HubSpot (Recommended)       | Salesforce, Pipedrive     |
| Data enrichment       | `~~data enrichment`           | Clay, Apollo, LinkedIn      | ZoomInfo, Clearbit, Lusha |
...
| Automation            | `~~automation`                | Zapier                      | Make, n8n                 |
